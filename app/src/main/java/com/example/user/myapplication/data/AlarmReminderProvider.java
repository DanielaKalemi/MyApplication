...
public class AlarmReminderProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITY, AlarmReminderContract.PATH_MEDICINES, REMINDER);
        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITY, AlarmReminderContract.PATH_MEDICINES + "/#", REMINDER_ID);
    }
