...
public class activity_alarm_items extends CursorAdapter {
    ...
    public activity_alarm_items(Context context, Cursor c) {
        super(context, c, 0);
    }
    ...
    public void setActiveImage(String active) {
        if (active.equals("true")) {
            mActiveImage.setImageResource(R.drawable.silent);
        } else if (active.equals("false")) {
            mActiveImage.setImageResource(R.drawable.silent1);
        }
    }
}
