...
import com.example.user.myapplication.data.AlarmReminderContract;
import com.example.user.myapplication.reminder.AlarmScheduler;
...
public class activity_medicine extends AppCompatActivity implements
    ...
    private static final long milWeek = 6048000000L;
    private static final long milMonth = 25920000000L;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            setTitle(R.string.editor_activity_title_edit_reminder);
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mMedicineHasChanged) {
                    NavUtils.navigateUpFromSameTask(activity_medicine.this);
                    return true;
                }
...
*/
        ...
        if (mCurrentReminderUri == null) {
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this, ("Remider Updated"),
                        Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void restartLoader() {
        getSupportLoaderManager().restartLoader(VEHICLE_LOADER, null, (android.support.v4.app.LoaderManager.LoaderCallbacks<Object>) this);
    }
